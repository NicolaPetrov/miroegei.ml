...
var colors = ['#000', '#000', '#000'];
var random_color = colors[Math.floor(Math.random() * colors.length)];
document.getElementById('car').style.color = random_color;
...
function renderCar (car) {
  ...
  if ((power > 0.0025) || reverse) {
    ...
    ctx.fillRect(
      x - Math.cos(angle + 7 * Math.PI / 2) * 3 + Math.cos(angle + 2 * Math.PI / 2) * 3,
      y - Math.sin(angle + 7 * Math.PI / 2) * 3 + Math.sin(angle + 2 * Math.PI / 2) * 3,
      1.5,
      1.5
    );
    ctx.fillRect(
      x - Math.cos(angle + 7 * Math.PI / 2) * 3 + Math.cos(angle + 4 * Math.PI / 2) * 3,
      y - Math.sin(angle + 7 * Math.PI / 2) * 3 + Math.sin(angle + 4 * Math.PI / 2) * 3,
      1,
      1
    );
  }
